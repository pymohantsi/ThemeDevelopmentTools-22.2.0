{{#if showQuantity}}
<p><span class="transaction-line-views-quantity-amount-label">{{translate 'Quantity:'}} </span> <span
		class="transaction-line-views-quantity-amount-value">{{line.quantity}}</span></p>
{{/if}}
...
<p>
	...
	<span class="transaction-line-views-quantity-amount-non-discounted-amount">
		{{line.amount_formatted}} {{#if tariff}} + {{tariff}}(Tariff){{/if}}
	</span>
	{{else}}
	<span class="transaction-line-views-quantity-amount-item-amount">
		{{line.amount_formatted}} {{#if tariff}} + {{tariff}}(Tariff){{/if}}
