<div class="header-message-section">
	<div class="header-message-section-container">
		...
		<div id="banner-header-top" class="contact-info" data-cms-area="header_banner_top" data-cms-area-filters="global"></div>
		
		<div class="header-message" data-view="Message.Placeholder"></div>

		<div id="header-top-social-icon" class="social-icon" data-cms-area="header_top_social_icon" data-cms-area-filters="global"></div>
	</div>
</div>
...
<div class="header-section">
	<div class="site-wrapper header-wrapper">
		...
		<div class="header-search-wrapper" data-view="SiteSearch">
			
		</div>
		<div class="header-login-wrapper">Login</div>
	</div>
</div
