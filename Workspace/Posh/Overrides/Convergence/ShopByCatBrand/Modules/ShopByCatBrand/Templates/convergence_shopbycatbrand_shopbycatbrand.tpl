...
{{/each}}
	  ...
	  {{#ifEquals @index 0}}
	  <a data-touchpoint="home" {{#ifEquals custrecord_cv_shop_by_cat_applied_for "2"}} data-hashtag="/shop-by-category" {{/ifEquals}} {{#ifEquals custrecord_cv_shop_by_cat_applied_for "1"}} data-hashtag="/Shop_by_Brand" {{/ifEquals}} class="category">
		<svg id="Group_1034" data-name="Group 1034" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="61.793" height="61.651" viewBox="0 0 61.793 61.651">
		<defs>
			<clipPath id="clip-path">
			<rect id="Rectangle_120" data-name="Rectangle 120" width="61.793" height="61.651" transform="translate(0 0)"/>
			</clipPath>
		</defs>
		<g id="Group_1033" data-name="Group 1033" clip-path="url(#clip-path)">
			<path id="Path_913" data-name="Path 913" d="M49.868,29.93c-2.359,0-4.394-.073-5.73-.2a6.34,6.34,0,0,1-4.918-4.1c-.656-2.146-.6-9.134-.388-12.279.194-2.828,1.556-4.963,3.737-5.855,1.072-.439,4.077-.7,8.036-.7,2.072,0,3.823.069,4.771.134a6.481,6.481,0,0,1,6.234,4.893,47.181,47.181,0,0,0,.049,6.269,38.607,38.607,0,0,1-.027,6.713,6.283,6.283,0,0,1-5.442,4.924c-1.58.126-3.943.2-6.322.2m-5.757-5.313H56.52V12.208H44.111Z"/>
			<path id="Path_914" data-name="Path 914" d="M49.871,61.651c-2.36,0-4.4-.073-5.733-.205a6.34,6.34,0,0,1-4.918-4.094c-.656-2.147-.6-9.135-.388-12.28.194-2.829,1.556-4.963,3.737-5.855,1.072-.439,4.075-.7,8.033-.7,2.074,0,3.826.07,4.774.134a6.487,6.487,0,0,1,6.247,4.938V56.54a6.268,6.268,0,0,1-5.432,4.911c-1.58.125-3.942.2-6.319.2Zm-5.76-5.313H56.52V43.929H44.111Z"/>
			<path id="Path_915" data-name="Path 915" d="M18.237,61.617c-2.606,0-5-.074-5.952-.186C9,61.048,7.3,57.929,7.111,55.193a88.513,88.513,0,0,1,0-10.12c.258-3.769,2.391-6.03,6.008-6.367,1.4-.131,3.351-.2,5.5-.2,1.824,0,3.66.053,5.038.147,2.777.189,5.917,1.93,6.251,5.305a85.067,85.067,0,0,1-.018,12.328,6.23,6.23,0,0,1-4.322,4.977A47.3,47.3,0,0,1,18.237,61.617ZM12.39,56.338H24.8V43.929H12.39Z"/>
			<path id="Path_916" data-name="Path 916" d="M10.115,29.865c-1.624,0-3.046-.044-4.347-.134a6.126,6.126,0,0,1-5.6-5.286A87.641,87.641,0,0,1,.149,13.922C.261,10.9.376,7.773.23,4.827A6.545,6.545,0,0,1,4.946,0H25.138a6.409,6.409,0,0,1,4.74,5.1c-.152,2.954-.047,6.061.056,9.068a91.919,91.919,0,0,1-.022,10.116A6.128,6.128,0,0,1,24.8,29.7c-.986-.044-2.031-.066-3.191-.066-1.913,0-3.876.061-5.775.118s-3.834.117-5.718.117M5.286,24.617H24.8V5.1H5.286Z"/>
		</g>
		</svg>

		<span>
		{{#ifEquals custrecord_cv_shop_by_cat_applied_for "2"}}
            All Categories
		 {{/ifEquals}}
		 {{#ifEquals custrecord_cv_shop_by_cat_applied_for "1"}}
            All Brand
		 {{/ifEquals}}
        </span>
		</a>
		...
		<a  data-touchpoint="home" data-hashtag="{{fullurl}}" class="category" data-text="{{custrecord_cv_shop_by_cat_applied_for}}">
		{{#ifEquals custrecord_cv_shop_by_cat_applied_for "2"}}
			{{{custrecord_cv_shop_by_cat_image_svg}}}
			<span>
				{{name}}
			</span>
		{{/ifEquals}}
		{{#ifEquals custrecord_cv_shop_by_cat_applied_for "1"}}
				...
				<img src="{{custrecord_cv_shop_by_cat_image}}" alt="">
		{{/ifEquals}}
